...
#     renderer.draw_vector(v1, (255,0,0))
#     renderer.draw_vector(v2, (0,255,0))
#     renderer.draw_vector(v3, (0,0,255))
...
screen = pygame.display.set_mode((WIDTH, HEIGHT))
pygame.display.set_caption("3D Vector Visualizer")
...
while running:
    ...
    renderer.draw_vector(v1,(255,80,80))
    renderer.draw_vector(v2,(80,255,80))
    renderer.draw_vector(v3,(80,80,255))
